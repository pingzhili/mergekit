models=("checkpoints/exp-0-3-hybrid-mlp-expert/mix-moe" "checkpoints/exp-0-3-hybrid-mlp-expert/hybrid-moe-dense-8" "checkpoints/exp-0-3-hybrid-mlp-expert/hybrid-moe-dense-16" "checkpoints/exp-0-3-hybrid-mlp-expert/hybrid-moe-dense-24")
i=0
for model in "${models[@]}"; do
    ...
    CUDA_VISIBLE_DEVICES=2,3 accelerate launch --main_process_port 21001 ../bigcode-evaluation-harness/main.py \
      --model $model \
      --tasks humaneval \

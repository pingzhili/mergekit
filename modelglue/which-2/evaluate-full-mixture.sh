models=("modelglue/which-2/full_ffn_lv_mixed_moe" "modelglue/which-2/ffn_mixed_moe")
i=0
for model in "${models[@]}"; do
    ((i++))
    CUDA_VISIBLE_DEVICES=0,1,2,3 accelerate launch --main_process_port 21003  -m lm_eval --model hf \
    ...
    CUDA_VISIBLE_DEVICES=0,1,2,3 accelerate launch --main_process_port 21003 ../bigcode-evaluation-harness/main.py \
      --model $model \
      --tasks humaneval \

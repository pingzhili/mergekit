models=("modelglue/which-4/full_block_lv_mixed_moe" "modelglue/which-4/full_model_lv_mixed_moe")
i=5
for model in "${models[@]}"; do
    ((i++))
    CUDA_VISIBLE_DEVICES=4,5,6,7 accelerate launch --main_process_port 21002  -m lm_eval --model hf \
    ...
    CUDA_VISIBLE_DEVICES=4,5,6,7 accelerate launch --main_process_port 21002 ../bigcode-evaluation-harness/main.py \
      --model $model \
      --tasks humaneval \

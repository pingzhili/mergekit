...
for model in "${models[@]}"; do
    ((i++))
    CUDA_VISIBLE_DEVICES=0,1,2,3 accelerate launch --main_process_port 21002  -m lm_eval --model hf \
    ...
    CUDA_VISIBLE_DEVICES=0,1,2,3 accelerate launch --main_process_port 21002 ../bigcode-evaluation-harness/main.py \
      --model $model \
      --tasks humaneval \

models=("modelglue/which-4/full_ffn_lv_mixed_moe" )
i=1
...
#      --output_path ./5shot_winogrande_model_idx_$i.json >> output_model_idx_$i.out
    ...
    CUDA_VISIBLE_DEVICES=4,5,6,7 accelerate launch --main_process_port 21001 ../bigcode-evaluation-harness/main.py \
      --model $model \
      --tasks humaneval \

...
for model in "${models[@]}"; do
    ((i++))
    CUDA_VISIBLE_DEVICES=3,4,5,6,7 accelerate launch --main_process_port 21001  -m lm_eval --model hf \
    ...
    CUDA_VISIBLE_DEVICES=3,4,5,6,7 accelerate launch --main_process_port 21001 ../bigcode-evaluation-harness/main.py \
      --model $model \
      --tasks humaneval \
